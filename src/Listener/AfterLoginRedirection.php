...
class AfterLoginRedirection implements AuthenticationSuccessHandlerInterface
{
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token)
    {
        ...
        if (in_array('ROLE_ADMIN', $rolesTab, true)) {
            ...
            $redirection = new RedirectResponse($this->router->generate('dashboard_customer'));
        } elseif (in_array('ROLE_PARTNER', $rolesTab, true)) {
            $redirection = new RedirectResponse($this->router->generate('dashboard_partner'));
        } else {
